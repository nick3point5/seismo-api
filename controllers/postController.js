...
const create = (req, res) => {
	...
	db.Post.create(objData, (err, obj) => {
		if (err) {
			console.log("Error:");
			console.log(err);
		}
...
const show = (req, res) => {
	db.Post.findById(req.params.id, (err, obj) => {
		if (err) {
			console.log("Error:");
			console.log(err);
		}
...
const reply = (req, res) => {
	...
	db.Post.findById(req.params.id, (err, parentPost) => {
		if (err) {
			console.log("Error:");
			console.log(err);
		}

		db.Post.create(objData, (err, postObj) => {
			if (err) {
				console.log("Error:");
				console.log(err);
			}
...
function increaseMag(parent) {
	db.Post.findById(parent, (err, obj) => {
		if (err) {
			console.log("Error:");
			console.log(err);
		}
		...
		.then((obj) => {
			...
			db.Post.findByIdAndUpdate(obj._id, obj, { new: true }, (err, obj) => {
				if (err) {
					console.log("Error:");
					console.log(err);
				}
